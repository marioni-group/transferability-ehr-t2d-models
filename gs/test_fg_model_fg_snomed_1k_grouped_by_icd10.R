...
model_results_single_fold <- function(fold_number) {
  model_files_path <- "/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/models/r11_model_files/icd_category_grouping/"
  ...
  summary_test_ehr_model_coefficients <- read.csv(paste0("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/models/r11_model_files/icd_category_grouping/snomed_grouped_by_icd_1k_freq_cox_lasso_incremental_coefs_summary_test_ehr_model_result_fold_", fold_number, ".csv"))
  summary_test_full_model_coefficients <- read.csv(paste0("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/models/r11_model_files/icd_category_grouping/snomed_grouped_by_icd_1k_freq_cox_lasso_incremental_coefs_summary_test_full_model_result_fold_", fold_number, ".csv"))
  summary_test_interaction_model_coefficients <- read.csv(paste0("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/models/r11_model_files/icd_category_grouping/snomed_grouped_by_icd_1k_freq_cox_lasso_incremental_coefs_summary_test_interaction_model_result_fold_", fold_number, ".csv"))
  summary_test_null_model_coefficients <- read.csv(paste0("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/models/r11_model_files/icd_category_grouping/snomed_grouped_by_icd_1k_freq_cox_lasso_incremental_coefs_summary_test_null_model_result_fold_", fold_number, ".csv"))
  summary_test_prs_model_coefficients <- read.csv(paste0("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/models/r11_model_files/icd_category_grouping/snomed_grouped_by_icd_1k_freq_cox_lasso_incremental_coefs_summary_test_prs_model_result_fold_", fold_number, ".csv"))
  
  df <- readRDS(paste0("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/data/r11/gs_all_codes_presence_cox_table_snomed_grouped_by_icd10_fold_", fold_number, ".rds"))
  ...
  model_means <- read.csv(paste0("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/models/r11_model_files/icd_category_grouping/snomed_grouped_by_icd_1k_freq_cox_lasso_model_means_result_fold_", fold_number, ".csv"),
                          row.names = "X")
  ...
  basehazes <- read.csv(paste0("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/models/r11_model_files/icd_category_grouping/snomed_grouped_by_icd_1k_freq_cox_lasso_basehazes_result_fold_", fold_number, ".csv"))
...
saveRDS(results, "/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/results/r11/test_fg_model_fg_snomed_1k_grouped_by_icd10_results_with_auc_cindex_brier.rds")
