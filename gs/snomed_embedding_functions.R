...
load_embedding_table <- function() {
  embedding_table <- unique(read.csv("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/data/embeddings.csv"))
...
load_icd_embedding_table <- function() {
  icd_embeddings <- read.csv("/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/data/r11/icd_embeddings_text-embedding-ada-002.csv")
