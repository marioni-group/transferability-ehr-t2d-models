...
result <- result %>% left_join(coxTable[,c("Sample_Name", "Age", "sex", "Event", "time_to_event")], by = c("id" = "Sample_Name"))
...
# saveRDS(result, "/Cluster_Filespace/Marioni_Group/Yipeng/prediction-pipelines/ehr_t2d/data/r11/gs_all_codes_presence_cox_table.rds")
